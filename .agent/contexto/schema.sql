...
-- Tiempo de generación: 25-03-2026 a las 20:40:15
...
--
-- Base de datos: `u839374897_erp`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `acciones_tools_erp`
--
...
--
-- Estructura de tabla para la tabla `announcement_branches`
--
...
--
-- Estructura de tabla para la tabla `announcement_views`
--
...
--
-- Estructura de tabla para la tabla `archivos_presentacion_producto`
--
...
--
-- Estructura de tabla para la tabla `AsignacionNivelesCargos`
--
...
--
-- Estructura de tabla para la tabla `auditoria_caja_chica`
--
...
--
-- Estructura de tabla para la tabla `auditoria_caja_chica_detalle`
--
...
--
-- Estructura de tabla para la tabla `auditoria_facturacion`
--
...
--
-- Estructura de tabla para la tabla `auditoria_fotos`
--
...
--
-- Estructura de tabla para la tabla `auditoria_inventario_detalle`
--
...
--
-- Estructura de tabla para la tabla `auditoria_inventario_operarios`
--
...
--
-- Estructura de tabla para la tabla `auditoria_personal`
--
...
--
-- Estructura de tabla para la tabla `auditoria_personal_fotos`
--
...
--
-- Estructura de tabla para la tabla `auditoria_promociones`
--
...
--
-- Estructura de tabla para la tabla `auditoria_servicio`
--
...
--
-- Estructura de tabla para la tabla `auditoria_servicio_fotos`
--
...
--
-- Estructura de tabla para la tabla `AutorizacionesEdicion`
--
...
--
-- Estructura de tabla para la tabla `BitacoraColaborador`
--
...
--
-- Estructura de tabla para la tabla `BoletaAguinaldo`
--
...
--
-- Estructura de tabla para la tabla `bot_estado_confirmacion`
--
...
--
-- Estructura de tabla para la tabla `bot_intents`
--
...
--
-- Estructura de tabla para la tabla `bot_operaciones_log`
--
...
--
-- Estructura de tabla para la tabla `caja_chica_sucursales`
--
...
--
-- Estructura de tabla para la tabla `CategoriasOperarios`
--
...
--
-- Estructura de tabla para la tabla `categoria_producto_maestro`
--
...
--
-- Estructura de tabla para la tabla `clientesclub`
--
...
--
-- Estructura de tabla para la tabla `componentes_receta_producto`
--
...
--
-- Estructura de tabla para la tabla `compra_local_configuracion_despacho`
--
...
--
-- Estructura de tabla para la tabla `compra_local_pedidos_historico`
--
...
--
-- Estructura de tabla para la tabla `compra_local_perfiles_despacho`
--
...
--
-- Estructura de tabla para la tabla `ContactosEmergencia`
--
...
--
-- Estructura de tabla para la tabla `contratos_tiposDocumentos`
--
...
--
-- Estructura de tabla para la tabla `conversion_unidad_producto`
--
...
--
-- Estructura de tabla para la tabla `cupones_sucursales`
--
...
--
-- Estructura de tabla para la tabla `DBBatidos`
--
...
--
-- Estructura de tabla para la tabla `DBIngredientes`
--
...
--
-- Estructura de tabla para la tabla `deducciones_operaciones`
--
...
--
-- Estructura de tabla para la tabla `diccionario_productos_legado`
--
...
--
-- Estructura de tabla para la tabla `DVR_Sucursales`
--
...
--
-- Estructura de tabla para la tabla `endulzantes`
--
...
--
-- Estructura de tabla para la tabla `endulzantes_asignaciones`
--
...
--
-- Estructura de tabla para la tabla `entrevistas_candidatos`
--
...
--
-- Estructura de tabla para la tabla `faltante_caja`
--
...
--
-- Estructura de tabla para la tabla `faltante_danos`
--
...
--
-- Estructura de tabla para la tabla `faltante_danos_operarios`
--
...
--
-- Estructura de tabla para la tabla `faltante_inventario`
--
...
--
-- Estructura de tabla para la tabla `faltante_inventario_detalle`
--
...
--
-- Estructura de tabla para la tabla `faltante_inventario_operarios`
--
...
--
-- Estructura de tabla para la tabla `faltas_manual`
--
...
--
-- Estructura de tabla para la tabla `FechasSistema`
--
...
--
-- Estructura de tabla para la tabla `feriadosnic`
--
...
--
-- Estructura de tabla para la tabla `FeriadosStatus`
--
...
--
-- Estructura de tabla para la tabla `fichatecnica_presentacion_producto`
--
...
--
-- Estructura de tabla para la tabla `formato_salida`
--
...
--
-- Estructura de tabla para la tabla `fotos_presentacion_producto`
--
...
--
-- Estructura de tabla para la tabla `gestion_proyectos_proyectos`
--
...
--
-- Estructura de tabla para la tabla `gestion_tareas_reuniones_archivos`
--
...
--
-- Estructura de tabla para la tabla `gestion_tareas_reuniones_comentarios`
--
...
--
-- Estructura de tabla para la tabla `gestion_tareas_reuniones_items`
--
...
--
-- Estructura de tabla para la tabla `gestion_tareas_reuniones_participantes`
--
...
--
-- Estructura de tabla para la tabla `gestores_reclamos`
--
...
--
-- Estructura de tabla para la tabla `GrupoProductosVenta`
--
...
--
-- Estructura de tabla para la tabla `grupo_presentacion_producto`
--
...
--
-- Estructura de tabla para la tabla `historial_estados_personal`
--
...
--
-- Estructura de tabla para la tabla `HorariosSemanales`
--
...
--
-- Estructura de tabla para la tabla `HorariosSemanalesOperaciones`
--
...
--
-- Estructura de tabla para la tabla `HorasExtraStatus`
--
...
--
-- Estructura de tabla para la tabla `horas_extras_manual`
--
...
--
-- Estructura de tabla para la tabla `ia_graficos_cache`
--
...
--
-- Estructura de tabla para la tabla `ia_graficos_diccionario_columnas`
--
...
--
-- Estructura de tabla para la tabla `ia_graficos_favoritos`
--
...
--
-- Estructura de tabla para la tabla `ia_graficos_filtros_conceptuales`
--
...
--
-- Estructura de tabla para la tabla `ia_graficos_metricas_predefinidas`
--
...
--
-- Estructura de tabla para la tabla `ia_graficos_validaciones`
--
...
--
-- Estructura de tabla para la tabla `ia_proveedores_api`
--
...
--
-- Estructura de tabla para la tabla `IndicadoresSemanales`
--
...
--
-- Estructura de tabla para la tabla `IndicadoresSemanalesResultados`
--
...
--
-- Estructura de tabla para la tabla `intent_embeddings`
--
...
--
-- Estructura de tabla para la tabla `kpi_reclamos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_mantenimientos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_mantenimientos_fotos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_mantenimientos_programados`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_mantenimientos_repuestos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_movimientos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_repuestos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_solicitudes`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_solicitudes_fotos`
--
...
--
-- Estructura de tabla para la tabla `mtto_equipos_tipos`
--
...
--
-- Estructura de tabla para la tabla `mtto_informes_diarios`
--
...
--
-- Estructura de tabla para la tabla `mtto_informe_compras`
--
...
--
-- Estructura de tabla para la tabla `mtto_informe_tareas`
--
...
--
-- Estructura de tabla para la tabla `mtto_informe_tareas_fotos`
--
...
--
-- Estructura de tabla para la tabla `mtto_informe_visitas`
--
...
--
-- Estructura de tabla para la tabla `mtto_materiales_frecuentes`
--
...
--
-- Estructura de tabla para la tabla `mtto_tickets`
--
...
--
-- Estructura de tabla para la tabla `mtto_tickets_colaboradores`
--
...
--
-- Estructura de tabla para la tabla `mtto_tickets_fotos`
--
...
--
-- Estructura de tabla para la tabla `mtto_tickets_fotos_finalizacion`
--
...
--
-- Estructura de tabla para la tabla `mtto_tickets_materiales`
--
...
--
-- Estructura de tabla para la tabla `mtto_tipos_casos`
--
...
--
-- Estructura de tabla para la tabla `NivelesCargos`
--
...
CREATE TABLE `Operarios` (
  ...
  `bot_imap_host` varchar(100) DEFAULT NULL COMMENT 'Host IMAP para búsqueda de correos del operario',
  `bot_imap_port` int(11) DEFAULT 993 COMMENT 'Puerto IMAP (993 SSL)',
...
--
-- Estructura de tabla para la tabla `OperariosCategorias`
--
...
--
-- Estructura de tabla para la tabla `PagoAdelantos`
--
...
--
-- Estructura de tabla para la tabla `PatronalesINSS`
--
...
--
-- Estructura de tabla para la tabla `pedidos_impresiones`
--
...
--
-- Estructura de tabla para la tabla `permisos_tools_erp`
--
...
--
-- Estructura de tabla para la tabla `personal_auditorias`
--
...
--
-- Estructura de tabla para la tabla `pitaya_love_registros`
--
...
--
-- Estructura de tabla para la tabla `plazas_cargos`
--
...
--
-- Estructura de tabla para la tabla `postulacion_entrevista_telefonica`
--
...
--
-- Estructura de tabla para la tabla `postulacion_evaluacion_jefe`
--
...
--
-- Estructura de tabla para la tabla `postulacion_evaluacion_rh`
--
...
--
-- Estructura de tabla para la tabla `postulacion_plaza`
--
...
--
-- Estructura de tabla para la tabla `productos_delivery`
--
...
--
-- Estructura de tabla para la tabla `producto_maestro`
--
...
--
-- Estructura de tabla para la tabla `promociones_aplicacion`
--
...
--
-- Estructura de tabla para la tabla `promociones_clientes_tipos`
--
...
--
-- Estructura de tabla para la tabla `promociones_grupos`
--
...
--
-- Estructura de tabla para la tabla `promociones_requisitos`
--
...
--
-- Estructura de tabla para la tabla `promociones_tipos`
--
...
--
-- Estructura de tabla para la tabla `promo_condiciones`
--
...
--
-- Estructura de tabla para la tabla `promo_condiciones_opciones`
--
...
--
-- Estructura de tabla para la tabla `promo_promociones`
--
...
--
-- Estructura de tabla para la tabla `proveedores_compras_servicios`
--
...
--
-- Estructura de tabla para la tabla `proveedor_tipo_pago`
--
...
--
-- Estructura de tabla para la tabla `qr_offline_bank`
--
...
--
-- Estructura de tabla para la tabla `receta_producto_global`
--
...
--
-- Estructura de tabla para la tabla `reclamos_cargos_responsables`
--
...
--
-- Estructura de tabla para la tabla `reclamos_grupos`
--
...
--
-- Estructura de tabla para la tabla `reclamos_imagenes`
--
...
--
-- Estructura de tabla para la tabla `reclamos_productos`
--
...
--
-- Estructura de tabla para la tabla `reclamos_tipos`
--
...
--
-- Estructura de tabla para la tabla `reclamos_videos`
--
...
--
-- Estructura de tabla para la tabla `reembolsos_detalles`
--
...
--
-- Estructura de tabla para la tabla `reembolsos_solicitudes`
--
...
--
-- Estructura de tabla para la tabla `reportes_colaboradores`
--
...
--
-- Estructura de tabla para la tabla `reportes_investigacion`
--
...
--
-- Estructura de tabla para la tabla `requisicion_personal`
--
...
--
-- Estructura de tabla para la tabla `ResenasGoogle`
--
...
--
-- Estructura de tabla para la tabla `SalarioINSS`
--
...
--
-- Estructura de tabla para la tabla `SalarioOperario`
--
...
--
-- Estructura de tabla para la tabla `SemanasSistema`
--
...
--
-- Estructura de tabla para la tabla `servicios_delivery`
--
...
--
-- Estructura de tabla para la tabla `solicitudes_cotizacion_fotos`
--
...
--
-- Estructura de tabla para la tabla `solicitudes_cotizacion_historial`
--
...
--
-- Estructura de tabla para la tabla `solicitudes_cotizacion_productos`
--
...
--
-- Estructura de tabla para la tabla `solicitud_empleo_estudios`
--
...
--
-- Estructura de tabla para la tabla `solicitud_empleo_experiencia`
--
...
--
-- Estructura de tabla para la tabla `solicitud_empleo_familiares`
--
...
--
-- Estructura de tabla para la tabla `solicitud_empleo_hijos`
--
...
--
-- Estructura de tabla para la tabla `solicitud_empleo_referencias`
--
...
--
-- Estructura de tabla para la tabla `subgrupos_productos`
--
...
--
-- Estructura de tabla para la tabla `subgrupo_presentacion_producto`
--
...
--
-- Estructura de tabla para la tabla `SubReceta`
--
...
--
-- Estructura de tabla para la tabla `TardanzasManuales`
--
...
--
-- Estructura de tabla para la tabla `TardanzasStatus`
--
...
--
-- Estructura de tabla para la tabla `tipos_falta`
--
...
--
-- Estructura de tabla para la tabla `tipo_estado_horario`
--
...
--
-- Estructura de tabla para la tabla `tipo_pago_proveedores`
--
...
--
-- Estructura de tabla para la tabla `tipo_receta_producto`
--
...
--
-- Estructura de tabla para la tabla `tools_erp`
--
...
--
-- Estructura de tabla para la tabla `validacion_cv_ia`
--
...
--
-- Estructura de tabla para la tabla `variedad_producto_presentacion`
--
...
--
-- Estructura de tabla para la tabla `VentasGlobalesAccessCSV`
--
...
--
-- Estructura de tabla para la tabla `ventas_detalle_promociones`
--
...
--
-- Estructura de tabla para la tabla `ventas_extras`
--
...
--
-- Estructura de tabla para la tabla `ventas_meta`
--
...
--
-- Estructura de tabla para la tabla `ventas_promociones`
--
...
--
-- Estructura Stand-in para la vista `view_deducciones_completas`
...
--
-- Estructura Stand-in para la vista `view_estadisticas_por_departamentos_y_semanas_reclamos`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_faltas_no_reportadas_septimo`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_permisos`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_reclamos_completa`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_reporte_tardanzas`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_reporte_tardanzas_completo`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_vacaciones`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `view_viaticos_exportar`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura Stand-in para la vista `VistaOperariosContratos`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura de tabla para la tabla `wsp_campanas_`
--
...
--
-- Estructura de tabla para la tabla `wsp_destinatarios_`
--
...
--
-- Estructura de tabla para la tabla `wsp_logs_`
--
...
--
-- Estructura de tabla para la tabla `wsp_planilla_programaciones_`
--
...
--
-- Estructura de tabla para la tabla `wsp_sesion_vps_`
--
...
--
-- Indices de la tabla `acciones_tools_erp`
--
...
--
-- Indices de la tabla `announcement_branches`
--
...
--
-- Indices de la tabla `announcement_views`
--
...
--
-- Indices de la tabla `archivos_presentacion_producto`
--
...
--
-- Indices de la tabla `AsignacionNivelesCargos`
--
...
--
-- Indices de la tabla `auditoria_caja_chica`
--
...
--
-- Indices de la tabla `auditoria_caja_chica_detalle`
--
...
--
-- Indices de la tabla `auditoria_facturacion`
--
...
--
-- Indices de la tabla `auditoria_fotos`
--
...
--
-- Indices de la tabla `auditoria_inventario_detalle`
--
...
--
-- Indices de la tabla `auditoria_inventario_operarios`
--
...
--
-- Indices de la tabla `auditoria_personal`
--
ALTER TABLE `auditoria_personal`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `auditoria_personal_fotos`
--
...
--
-- Indices de la tabla `auditoria_promociones`
--
...
--
-- Indices de la tabla `auditoria_servicio`
--
ALTER TABLE `auditoria_servicio`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `auditoria_servicio_fotos`
--
...
--
-- Indices de la tabla `AutorizacionesEdicion`
--
...
--
-- Indices de la tabla `BitacoraColaborador`
--
...
--
-- Indices de la tabla `BoletaAguinaldo`
--
...
--
-- Indices de la tabla `bot_estado_confirmacion`
--
...
--
-- Indices de la tabla `bot_intents`
--
ALTER TABLE `bot_intents`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `bot_operaciones_log`
--
...
--
-- Indices de la tabla `caja_chica_sucursales`
--
...
--
-- Indices de la tabla `CategoriasOperarios`
--
ALTER TABLE `CategoriasOperarios`
  ADD PRIMARY KEY (`idCategoria`);

--
-- Indices de la tabla `categoria_producto_maestro`
--
...
--
-- Indices de la tabla `clientesclub`
--
...
--
-- Indices de la tabla `componentes_receta_producto`
--
...
--
-- Indices de la tabla `compra_local_configuracion_despacho`
--
...
--
-- Indices de la tabla `compra_local_pedidos_historico`
--
...
--
-- Indices de la tabla `compra_local_perfiles_despacho`
--
ALTER TABLE `compra_local_perfiles_despacho`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ContactosEmergencia`
--
...
--
-- Indices de la tabla `contratos_tiposDocumentos`
--
...
--
-- Indices de la tabla `conversion_unidad_producto`
--
...
--
-- Indices de la tabla `cupones_sucursales`
--
ALTER TABLE `cupones_sucursales`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `DBBatidos`
--
...
--
-- Indices de la tabla `deducciones_operaciones`
--
...
--
-- Indices de la tabla `diccionario_productos_legado`
--
...
--
-- Indices de la tabla `DVR_Sucursales`
--
...
--
-- Indices de la tabla `endulzantes`
--
ALTER TABLE `endulzantes`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `endulzantes_asignaciones`
--
...
--
-- Indices de la tabla `entrevistas_candidatos`
--
...
--
-- Indices de la tabla `faltante_caja`
--
...
--
-- Indices de la tabla `faltante_danos`
--
ALTER TABLE `faltante_danos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `faltante_danos_operarios`
--
...
--
-- Indices de la tabla `faltante_inventario`
--
...
--
-- Indices de la tabla `faltante_inventario_detalle`
--
...
--
-- Indices de la tabla `faltante_inventario_operarios`
--
...
--
-- Indices de la tabla `faltas_manual`
--
...
--
-- Indices de la tabla `feriadosnic`
--
...
--
-- Indices de la tabla `FeriadosStatus`
--
...
--
-- Indices de la tabla `fichatecnica_presentacion_producto`
--
...
--
-- Indices de la tabla `formato_salida`
--
...
--
-- Indices de la tabla `fotos_presentacion_producto`
--
...
--
-- Indices de la tabla `gestion_proyectos_proyectos`
--
...
--
-- Indices de la tabla `gestion_tareas_reuniones_archivos`
--
...
--
-- Indices de la tabla `gestion_tareas_reuniones_comentarios`
--
...
--
-- Indices de la tabla `gestion_tareas_reuniones_items`
--
...
--
-- Indices de la tabla `gestion_tareas_reuniones_participantes`
--
...
--
-- Indices de la tabla `gestores_reclamos`
--
...
--
-- Indices de la tabla `grupo_presentacion_producto`
--
...
--
-- Indices de la tabla `historial_estados_personal`
--
...
--
-- Indices de la tabla `HorariosSemanales`
--
...
--
-- Indices de la tabla `HorariosSemanalesOperaciones`
--
...
--
-- Indices de la tabla `HorasExtraStatus`
--
...
--
-- Indices de la tabla `horas_extras_manual`
--
...
--
-- Indices de la tabla `ia_graficos_cache`
--
...
--
-- Indices de la tabla `ia_graficos_diccionario_columnas`
--
...
--
-- Indices de la tabla `ia_graficos_favoritos`
--
...
--
-- Indices de la tabla `ia_graficos_filtros_conceptuales`
--
ALTER TABLE `ia_graficos_filtros_conceptuales`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ia_graficos_metricas_predefinidas`
--
ALTER TABLE `ia_graficos_metricas_predefinidas`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ia_graficos_validaciones`
--
ALTER TABLE `ia_graficos_validaciones`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `ia_proveedores_api`
--
ALTER TABLE `ia_proveedores_api`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `IndicadoresSemanales`
--
...
--
-- Indices de la tabla `IndicadoresSemanalesResultados`
--
...
--
-- Indices de la tabla `intent_embeddings`
--
...
--
-- Indices de la tabla `kpi_reclamos`
--
...
--
-- Indices de la tabla `mtto_equipos`
--
...
--
-- Indices de la tabla `mtto_equipos_mantenimientos`
--
...
--
-- Indices de la tabla `mtto_equipos_mantenimientos_fotos`
--
...
--
-- Indices de la tabla `mtto_equipos_mantenimientos_programados`
--
...
--
-- Indices de la tabla `mtto_equipos_mantenimientos_repuestos`
--
...
--
-- Indices de la tabla `mtto_equipos_movimientos`
--
...
--
-- Indices de la tabla `mtto_equipos_repuestos`
--
ALTER TABLE `mtto_equipos_repuestos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `mtto_equipos_solicitudes`
--
...
--
-- Indices de la tabla `mtto_equipos_solicitudes_fotos`
--
...
--
-- Indices de la tabla `mtto_equipos_tipos`
--
ALTER TABLE `mtto_equipos_tipos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `mtto_informes_diarios`
--
...
--
-- Indices de la tabla `mtto_informe_compras`
--
...
--
-- Indices de la tabla `mtto_informe_tareas`
--
...
--
-- Indices de la tabla `mtto_informe_tareas_fotos`
--
...
--
-- Indices de la tabla `mtto_informe_visitas`
--
...
--
-- Indices de la tabla `mtto_materiales_frecuentes`
--
...
--
-- Indices de la tabla `mtto_tickets`
--
...
--
-- Indices de la tabla `mtto_tickets_colaboradores`
--
...
--
-- Indices de la tabla `mtto_tickets_fotos`
--
...
--
-- Indices de la tabla `mtto_tickets_fotos_finalizacion`
--
...
--
-- Indices de la tabla `mtto_tickets_materiales`
--
...
--
-- Indices de la tabla `mtto_tipos_casos`
--
ALTER TABLE `mtto_tipos_casos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `NivelesCargos`
--
...
--
-- Indices de la tabla `OperariosCategorias`
--
...
--
-- Indices de la tabla `PagoAdelantos`
--
...
--
-- Indices de la tabla `PatronalesINSS`
--
ALTER TABLE `PatronalesINSS`
  ADD PRIMARY KEY (`CodPlanilla`);

--
-- Indices de la tabla `permisos_tools_erp`
--
...
--
-- Indices de la tabla `personal_auditorias`
--
...
--
-- Indices de la tabla `pitaya_love_registros`
--
...
--
-- Indices de la tabla `plazas_cargos`
--
...
--
-- Indices de la tabla `postulacion_entrevista_telefonica`
--
...
--
-- Indices de la tabla `postulacion_evaluacion_jefe`
--
...
--
-- Indices de la tabla `postulacion_evaluacion_rh`
--
...
--
-- Indices de la tabla `postulacion_plaza`
--
...
--
-- Indices de la tabla `productos_delivery`
--
...
--
-- Indices de la tabla `producto_maestro`
--
...
--
-- Indices de la tabla `producto_presentacion`
--
...
--
-- Indices de la tabla `promociones_aplicacion`
--
ALTER TABLE `promociones_aplicacion`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `promociones_clientes_tipos`
--
ALTER TABLE `promociones_clientes_tipos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `promociones_grupos`
--
...
--
-- Indices de la tabla `promociones_requisitos`
--
...
--
-- Indices de la tabla `promociones_tipos`
--
ALTER TABLE `promociones_tipos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `promo_condiciones`
--
...
--
-- Indices de la tabla `promo_condiciones_opciones`
--
...
--
-- Indices de la tabla `promo_promociones`
--
...
--
-- Indices de la tabla `proveedores_compras_servicios`
--
ALTER TABLE `proveedores_compras_servicios`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `proveedor_tipo_pago`
--
...
--
-- Indices de la tabla `qr_offline_bank`
--
...
--
-- Indices de la tabla `receta_producto_global`
--
...
--
-- Indices de la tabla `reclamos_cargos_responsables`
--
...
--
-- Indices de la tabla `reclamos_grupos`
--
ALTER TABLE `reclamos_grupos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `reclamos_imagenes`
--
...
--
-- Indices de la tabla `reclamos_productos`
--
...
--
-- Indices de la tabla `reclamos_tipos`
--
...
--
-- Indices de la tabla `reclamos_videos`
--
...
--
-- Indices de la tabla `reembolsos_detalles`
--
...
--
-- Indices de la tabla `reembolsos_solicitudes`
--
...
--
-- Indices de la tabla `reportes_colaboradores`
--
...
--
-- Indices de la tabla `reportes_investigacion`
--
...
--
-- Indices de la tabla `requisicion_personal`
--
...
--
-- Indices de la tabla `SalarioINSS`
--
...
--
-- Indices de la tabla `SalarioOperario`
--
...
--
-- Indices de la tabla `SemanasSistema`
--
...
--
-- Indices de la tabla `servicios_delivery`
--
...
--
-- Indices de la tabla `solicitudes_cotizacion_fotos`
--
...
--
-- Indices de la tabla `solicitudes_cotizacion_historial`
--
...
--
-- Indices de la tabla `solicitudes_cotizacion_productos`
--
...
--
-- Indices de la tabla `solicitud_empleo_estudios`
--
...
--
-- Indices de la tabla `solicitud_empleo_experiencia`
--
...
--
-- Indices de la tabla `solicitud_empleo_familiares`
--
...
--
-- Indices de la tabla `solicitud_empleo_hijos`
--
...
--
-- Indices de la tabla `solicitud_empleo_referencias`
--
...
--
-- Indices de la tabla `subgrupos_productos`
--
...
--
-- Indices de la tabla `subgrupo_presentacion_producto`
--
...
--
-- Indices de la tabla `TardanzasManuales`
--
...
--
-- Indices de la tabla `TardanzasStatus`
--
...
--
-- Indices de la tabla `tipos_falta`
--
...
--
-- Indices de la tabla `tipo_pago_proveedores`
--
...
--
-- Indices de la tabla `tipo_receta_producto`
--
...
--
-- Indices de la tabla `validacion_cv_ia`
--
...
--
-- Indices de la tabla `variedad_producto_presentacion`
--
...
--
-- Indices de la tabla `VentasGlobalesAccessCSV`
--
...
--
-- Indices de la tabla `ventas_detalle_promociones`
--
...
--
-- Indices de la tabla `ventas_extras`
--
...
--
-- Indices de la tabla `ventas_meta`
--
...
--
-- Indices de la tabla `ventas_promociones`
--
...
--
-- Indices de la tabla `wsp_campanas_`
--
...
--
-- Indices de la tabla `wsp_destinatarios_`
--
...
--
-- Indices de la tabla `wsp_planilla_programaciones_`
--
...
--
-- Indices de la tabla `wsp_sesion_vps_`
--
...
--
-- AUTO_INCREMENT de la tabla `acciones_tools_erp`
--
ALTER TABLE `acciones_tools_erp`
...
--
-- AUTO_INCREMENT de la tabla `announcement_views`
--
ALTER TABLE `announcement_views`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `archivos_presentacion_producto`
--
ALTER TABLE `archivos_presentacion_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `AsignacionNivelesCargos`
--
ALTER TABLE `AsignacionNivelesCargos`
...
--
-- AUTO_INCREMENT de la tabla `auditoria_caja_chica`
--
ALTER TABLE `auditoria_caja_chica`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_caja_chica_detalle`
--
ALTER TABLE `auditoria_caja_chica_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_facturacion`
--
ALTER TABLE `auditoria_facturacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_fotos`
--
ALTER TABLE `auditoria_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `auditoria_inventario_detalle`
--
ALTER TABLE `auditoria_inventario_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_inventario_operarios`
--
ALTER TABLE `auditoria_inventario_operarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_personal`
--
ALTER TABLE `auditoria_personal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_personal_fotos`
--
ALTER TABLE `auditoria_personal_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `auditoria_promociones`
--
ALTER TABLE `auditoria_promociones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_servicio`
--
ALTER TABLE `auditoria_servicio`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `auditoria_servicio_fotos`
--
ALTER TABLE `auditoria_servicio_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `AutorizacionesEdicion`
--
ALTER TABLE `AutorizacionesEdicion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `BitacoraColaborador`
--
ALTER TABLE `BitacoraColaborador`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `BoletaAguinaldo`
--
ALTER TABLE `BoletaAguinaldo`
...
--
-- AUTO_INCREMENT de la tabla `bot_estado_confirmacion`
--
ALTER TABLE `bot_estado_confirmacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `bot_intents`
--
ALTER TABLE `bot_intents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `bot_operaciones_log`
--
ALTER TABLE `bot_operaciones_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `caja_chica_sucursales`
--
ALTER TABLE `caja_chica_sucursales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `CategoriasOperarios`
--
ALTER TABLE `CategoriasOperarios`
  MODIFY `idCategoria` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `categoria_producto_maestro`
--
ALTER TABLE `categoria_producto_maestro`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `clientesclub`
--
ALTER TABLE `clientesclub`
  MODIFY `id_clienteclub` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `componentes_receta_producto`
--
ALTER TABLE `componentes_receta_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `compra_local_configuracion_despacho`
--
ALTER TABLE `compra_local_configuracion_despacho`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `compra_local_pedidos_historico`
--
ALTER TABLE `compra_local_pedidos_historico`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `compra_local_perfiles_despacho`
--
ALTER TABLE `compra_local_perfiles_despacho`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ContactosEmergencia`
--
ALTER TABLE `ContactosEmergencia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `contratos_tiposDocumentos`
--
ALTER TABLE `contratos_tiposDocumentos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `conversion_unidad_producto`
--
ALTER TABLE `conversion_unidad_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `cupones_sucursales`
--
ALTER TABLE `cupones_sucursales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `deducciones_operaciones`
--
ALTER TABLE `deducciones_operaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `diccionario_productos_legado`
--
ALTER TABLE `diccionario_productos_legado`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `endulzantes`
--
ALTER TABLE `endulzantes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `endulzantes_asignaciones`
--
ALTER TABLE `endulzantes_asignaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `entrevistas_candidatos`
--
ALTER TABLE `entrevistas_candidatos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `faltante_caja`
--
ALTER TABLE `faltante_caja`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `faltante_danos`
--
ALTER TABLE `faltante_danos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `faltante_danos_operarios`
--
ALTER TABLE `faltante_danos_operarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `faltante_inventario`
--
ALTER TABLE `faltante_inventario`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `faltante_inventario_detalle`
--
ALTER TABLE `faltante_inventario_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `faltante_inventario_operarios`
--
ALTER TABLE `faltante_inventario_operarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `faltas_manual`
--
ALTER TABLE `faltas_manual`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `feriadosnic`
--
ALTER TABLE `feriadosnic`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `FeriadosStatus`
--
ALTER TABLE `FeriadosStatus`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `fichatecnica_presentacion_producto`
--
ALTER TABLE `fichatecnica_presentacion_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `formato_salida`
--
ALTER TABLE `formato_salida`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `fotos_presentacion_producto`
--
ALTER TABLE `fotos_presentacion_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gestion_proyectos_proyectos`
--
ALTER TABLE `gestion_proyectos_proyectos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gestion_tareas_reuniones_archivos`
--
ALTER TABLE `gestion_tareas_reuniones_archivos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gestion_tareas_reuniones_comentarios`
--
ALTER TABLE `gestion_tareas_reuniones_comentarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gestion_tareas_reuniones_items`
--
ALTER TABLE `gestion_tareas_reuniones_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gestion_tareas_reuniones_participantes`
--
ALTER TABLE `gestion_tareas_reuniones_participantes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `gestores_reclamos`
--
ALTER TABLE `gestores_reclamos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `grupo_presentacion_producto`
--
ALTER TABLE `grupo_presentacion_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `historial_estados_personal`
--
ALTER TABLE `historial_estados_personal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `HorariosSemanales`
--
ALTER TABLE `HorariosSemanales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `HorariosSemanalesOperaciones`
--
ALTER TABLE `HorariosSemanalesOperaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `HorasExtraStatus`
--
ALTER TABLE `HorasExtraStatus`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `horas_extras_manual`
--
ALTER TABLE `horas_extras_manual`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ia_graficos_cache`
--
ALTER TABLE `ia_graficos_cache`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ia_graficos_diccionario_columnas`
--
ALTER TABLE `ia_graficos_diccionario_columnas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ia_graficos_favoritos`
--
ALTER TABLE `ia_graficos_favoritos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ia_graficos_filtros_conceptuales`
--
ALTER TABLE `ia_graficos_filtros_conceptuales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ia_graficos_metricas_predefinidas`
--
ALTER TABLE `ia_graficos_metricas_predefinidas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ia_graficos_validaciones`
--
ALTER TABLE `ia_graficos_validaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ia_proveedores_api`
--
ALTER TABLE `ia_proveedores_api`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `IndicadoresSemanales`
--
ALTER TABLE `IndicadoresSemanales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `IndicadoresSemanalesResultados`
--
ALTER TABLE `IndicadoresSemanalesResultados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `intent_embeddings`
--
ALTER TABLE `intent_embeddings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `kpi_reclamos`
--
ALTER TABLE `kpi_reclamos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `mtto_equipos`
--
ALTER TABLE `mtto_equipos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_mantenimientos`
--
ALTER TABLE `mtto_equipos_mantenimientos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_mantenimientos_fotos`
--
ALTER TABLE `mtto_equipos_mantenimientos_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_mantenimientos_programados`
--
ALTER TABLE `mtto_equipos_mantenimientos_programados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_mantenimientos_repuestos`
--
ALTER TABLE `mtto_equipos_mantenimientos_repuestos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_movimientos`
--
ALTER TABLE `mtto_equipos_movimientos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_repuestos`
--
ALTER TABLE `mtto_equipos_repuestos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_solicitudes`
--
ALTER TABLE `mtto_equipos_solicitudes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_solicitudes_fotos`
--
ALTER TABLE `mtto_equipos_solicitudes_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_equipos_tipos`
--
ALTER TABLE `mtto_equipos_tipos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_informes_diarios`
--
ALTER TABLE `mtto_informes_diarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_informe_compras`
--
ALTER TABLE `mtto_informe_compras`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_informe_tareas`
--
ALTER TABLE `mtto_informe_tareas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_informe_tareas_fotos`
--
ALTER TABLE `mtto_informe_tareas_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_informe_visitas`
--
ALTER TABLE `mtto_informe_visitas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_materiales_frecuentes`
--
ALTER TABLE `mtto_materiales_frecuentes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_tickets`
--
ALTER TABLE `mtto_tickets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'codigo numerico de cada solicitud';

--
-- AUTO_INCREMENT de la tabla `mtto_tickets_colaboradores`
--
ALTER TABLE `mtto_tickets_colaboradores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_tickets_fotos`
--
ALTER TABLE `mtto_tickets_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_tickets_fotos_finalizacion`
--
ALTER TABLE `mtto_tickets_fotos_finalizacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_tickets_materiales`
--
ALTER TABLE `mtto_tickets_materiales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `mtto_tipos_casos`
--
ALTER TABLE `mtto_tipos_casos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `NivelesCargos`
--
ALTER TABLE `NivelesCargos`
...
--
-- AUTO_INCREMENT de la tabla `OperariosCategorias`
--
ALTER TABLE `OperariosCategorias`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `PagoAdelantos`
--
ALTER TABLE `PagoAdelantos`
  MODIFY `CodPagoAdelanto` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `PatronalesINSS`
--
ALTER TABLE `PatronalesINSS`
  MODIFY `CodPlanilla` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `permisos_tools_erp`
--
ALTER TABLE `permisos_tools_erp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `personal_auditorias`
--
ALTER TABLE `personal_auditorias`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pitaya_love_registros`
--
ALTER TABLE `pitaya_love_registros`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `plazas_cargos`
--
ALTER TABLE `plazas_cargos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `postulacion_entrevista_telefonica`
--
ALTER TABLE `postulacion_entrevista_telefonica`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `postulacion_evaluacion_jefe`
--
ALTER TABLE `postulacion_evaluacion_jefe`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `postulacion_evaluacion_rh`
--
ALTER TABLE `postulacion_evaluacion_rh`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `postulacion_plaza`
--
ALTER TABLE `postulacion_plaza`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `productos_delivery`
--
ALTER TABLE `productos_delivery`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `producto_maestro`
--
ALTER TABLE `producto_maestro`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `producto_presentacion`
--
ALTER TABLE `producto_presentacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `promociones_aplicacion`
--
ALTER TABLE `promociones_aplicacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `promociones_clientes_tipos`
--
ALTER TABLE `promociones_clientes_tipos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `promociones_grupos`
--
ALTER TABLE `promociones_grupos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `promociones_requisitos`
--
ALTER TABLE `promociones_requisitos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `promociones_tipos`
--
ALTER TABLE `promociones_tipos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `promo_condiciones`
--
ALTER TABLE `promo_condiciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `promo_condiciones_opciones`
--
ALTER TABLE `promo_condiciones_opciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `promo_promociones`
--
ALTER TABLE `promo_promociones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `proveedores_compras_servicios`
--
ALTER TABLE `proveedores_compras_servicios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `proveedor_tipo_pago`
--
ALTER TABLE `proveedor_tipo_pago`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `qr_offline_bank`
--
ALTER TABLE `qr_offline_bank`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `receta_producto_global`
--
ALTER TABLE `receta_producto_global`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `reclamos_cargos_responsables`
--
ALTER TABLE `reclamos_cargos_responsables`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reclamos_grupos`
--
ALTER TABLE `reclamos_grupos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reclamos_imagenes`
--
ALTER TABLE `reclamos_imagenes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reclamos_productos`
--
ALTER TABLE `reclamos_productos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reclamos_tipos`
--
ALTER TABLE `reclamos_tipos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reclamos_videos`
--
ALTER TABLE `reclamos_videos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reembolsos_detalles`
--
ALTER TABLE `reembolsos_detalles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reembolsos_solicitudes`
--
ALTER TABLE `reembolsos_solicitudes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reportes_colaboradores`
--
ALTER TABLE `reportes_colaboradores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `reportes_investigacion`
--
ALTER TABLE `reportes_investigacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `requisicion_personal`
--
ALTER TABLE `requisicion_personal`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `SalarioINSS`
--
ALTER TABLE `SalarioINSS`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `SalarioOperario`
--
ALTER TABLE `SalarioOperario`
  MODIFY `CodSalarioOperario` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `SemanasSistema`
--
ALTER TABLE `SemanasSistema`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `servicios_delivery`
--
ALTER TABLE `servicios_delivery`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `solicitudes_cotizacion_fotos`
--
ALTER TABLE `solicitudes_cotizacion_fotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `solicitudes_cotizacion_historial`
--
ALTER TABLE `solicitudes_cotizacion_historial`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `solicitudes_cotizacion_productos`
--
ALTER TABLE `solicitudes_cotizacion_productos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `solicitud_empleo_estudios`
--
ALTER TABLE `solicitud_empleo_estudios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `solicitud_empleo_experiencia`
--
ALTER TABLE `solicitud_empleo_experiencia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `solicitud_empleo_familiares`
--
ALTER TABLE `solicitud_empleo_familiares`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `solicitud_empleo_hijos`
--
ALTER TABLE `solicitud_empleo_hijos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `solicitud_empleo_referencias`
--
ALTER TABLE `solicitud_empleo_referencias`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `subgrupos_productos`
--
ALTER TABLE `subgrupos_productos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `subgrupo_presentacion_producto`
--
ALTER TABLE `subgrupo_presentacion_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `TardanzasManuales`
--
ALTER TABLE `TardanzasManuales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `TardanzasStatus`
--
ALTER TABLE `TardanzasStatus`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tipo_pago_proveedores`
--
ALTER TABLE `tipo_pago_proveedores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tipo_receta_producto`
--
ALTER TABLE `tipo_receta_producto`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tools_erp`
--
ALTER TABLE `tools_erp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `validacion_cv_ia`
--
ALTER TABLE `validacion_cv_ia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `variedad_producto_presentacion`
--
ALTER TABLE `variedad_producto_presentacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `ventas_detalle_promociones`
--
ALTER TABLE `ventas_detalle_promociones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ventas_extras`
--
ALTER TABLE `ventas_extras`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ventas_meta`
--
ALTER TABLE `ventas_meta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ventas_promociones`
--
ALTER TABLE `ventas_promociones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `wsp_campanas_`
--
ALTER TABLE `wsp_campanas_`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `wsp_destinatarios_`
--
ALTER TABLE `wsp_destinatarios_`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `wsp_logs_`
--
ALTER TABLE `wsp_logs_`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `wsp_planilla_programaciones_`
--
ALTER TABLE `wsp_planilla_programaciones_`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `wsp_sesion_vps_`
--
ALTER TABLE `wsp_sesion_vps_`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Estructura para la vista `view_deducciones_completas`
--
...
--
-- Estructura para la vista `view_estadisticas_por_departamentos_y_semanas_reclamos`
--
...
--
-- Estructura para la vista `view_faltas_no_reportadas_septimo`
--
...
--
-- Estructura para la vista `view_permisos`
--
...
--
-- Estructura para la vista `view_reclamos_completa`
--
...
--
-- Estructura para la vista `view_reporte_tardanzas`
--
...
--
-- Estructura para la vista `view_reporte_tardanzas_completo`
--
...
--
-- Estructura para la vista `view_vacaciones`
--
...
--
-- Estructura para la vista `view_viaticos_exportar`
--
...
--
-- Estructura para la vista `VistaOperariosContratos`
--
...
--
-- Filtros para la tabla `acciones_tools_erp`
--
ALTER TABLE `acciones_tools_erp`
...
--
-- Filtros para la tabla `announcement_branches`
--
ALTER TABLE `announcement_branches`
...
--
-- Filtros para la tabla `archivos_presentacion_producto`
--
ALTER TABLE `archivos_presentacion_producto`
...
--
-- Filtros para la tabla `AsignacionNivelesCargos`
--
ALTER TABLE `AsignacionNivelesCargos`
...
--
-- Filtros para la tabla `auditoria_caja_chica`
--
ALTER TABLE `auditoria_caja_chica`
...
--
-- Filtros para la tabla `auditoria_caja_chica_detalle`
--
ALTER TABLE `auditoria_caja_chica_detalle`
...
--
-- Filtros para la tabla `auditoria_facturacion`
--
ALTER TABLE `auditoria_facturacion`
...
--
-- Filtros para la tabla `auditoria_fotos`
--
ALTER TABLE `auditoria_fotos`
...
--
-- Filtros para la tabla `auditoria_inventario_detalle`
--
ALTER TABLE `auditoria_inventario_detalle`
...
--
-- Filtros para la tabla `auditoria_inventario_operarios`
--
ALTER TABLE `auditoria_inventario_operarios`
...
--
-- Filtros para la tabla `auditoria_personal_fotos`
--
ALTER TABLE `auditoria_personal_fotos`
...
--
-- Filtros para la tabla `BoletaAguinaldo`
--
ALTER TABLE `BoletaAguinaldo`
...
--
-- Filtros para la tabla `componentes_receta_producto`
--
ALTER TABLE `componentes_receta_producto`
...
--
-- Filtros para la tabla `compra_local_configuracion_despacho`
--
ALTER TABLE `compra_local_configuracion_despacho`
...
--
-- Filtros para la tabla `compra_local_pedidos_historico`
--
ALTER TABLE `compra_local_pedidos_historico`
...
--
-- Filtros para la tabla `conversion_unidad_producto`
--
ALTER TABLE `conversion_unidad_producto`
...
--
-- Filtros para la tabla `deducciones_operaciones`
--
ALTER TABLE `deducciones_operaciones`
...
--
-- Filtros para la tabla `diccionario_productos_legado`
--
ALTER TABLE `diccionario_productos_legado`
...
--
-- Filtros para la tabla `faltante_inventario_operarios`
--
ALTER TABLE `faltante_inventario_operarios`
...
--
-- Filtros para la tabla `faltas_manual`
--
ALTER TABLE `faltas_manual`
...
--
-- Filtros para la tabla `fichatecnica_presentacion_producto`
--
ALTER TABLE `fichatecnica_presentacion_producto`
...
--
-- Filtros para la tabla `gestion_proyectos_proyectos`
--
ALTER TABLE `gestion_proyectos_proyectos`
...
--
-- Filtros para la tabla `gestion_tareas_reuniones_archivos`
--
ALTER TABLE `gestion_tareas_reuniones_archivos`
...
--
-- Filtros para la tabla `gestion_tareas_reuniones_comentarios`
--
ALTER TABLE `gestion_tareas_reuniones_comentarios`
...
--
-- Filtros para la tabla `gestion_tareas_reuniones_items`
--
ALTER TABLE `gestion_tareas_reuniones_items`
...
--
-- Filtros para la tabla `gestion_tareas_reuniones_participantes`
--
ALTER TABLE `gestion_tareas_reuniones_participantes`
...
--
-- Filtros para la tabla `grupo_presentacion_producto`
--
ALTER TABLE `grupo_presentacion_producto`
...
--
-- Filtros para la tabla `historial_estados_personal`
--
ALTER TABLE `historial_estados_personal`
...
--
-- Filtros para la tabla `HorariosSemanales`
--
ALTER TABLE `HorariosSemanales`
  ADD CONSTRAINT `fk_cod_operario` FOREIGN KEY (`cod_operario`) REFERENCES `Operarios` (`CodOperario`);

--
-- Filtros para la tabla `HorariosSemanalesOperaciones`
--
ALTER TABLE `HorariosSemanalesOperaciones`
...
--
-- Filtros para la tabla `kpi_reclamos`
--
ALTER TABLE `kpi_reclamos`
...
--
-- Filtros para la tabla `mtto_equipos`
--
ALTER TABLE `mtto_equipos`
...
--
-- Filtros para la tabla `mtto_equipos_mantenimientos`
--
ALTER TABLE `mtto_equipos_mantenimientos`
...
--
-- Filtros para la tabla `mtto_equipos_mantenimientos_fotos`
--
ALTER TABLE `mtto_equipos_mantenimientos_fotos`
...
--
-- Filtros para la tabla `mtto_equipos_mantenimientos_programados`
--
ALTER TABLE `mtto_equipos_mantenimientos_programados`
...
--
-- Filtros para la tabla `mtto_equipos_mantenimientos_repuestos`
--
ALTER TABLE `mtto_equipos_mantenimientos_repuestos`
...
--
-- Filtros para la tabla `mtto_equipos_movimientos`
--
ALTER TABLE `mtto_equipos_movimientos`
...
--
-- Filtros para la tabla `mtto_equipos_solicitudes`
--
ALTER TABLE `mtto_equipos_solicitudes`
...
--
-- Filtros para la tabla `mtto_tickets_colaboradores`
--
ALTER TABLE `mtto_tickets_colaboradores`
...
--
-- Filtros para la tabla `postulacion_entrevista_telefonica`
--
ALTER TABLE `postulacion_entrevista_telefonica`
...
--
-- Filtros para la tabla `postulacion_evaluacion_jefe`
--
ALTER TABLE `postulacion_evaluacion_jefe`
...
--
-- Filtros para la tabla `postulacion_evaluacion_rh`
--
ALTER TABLE `postulacion_evaluacion_rh`
...
--
-- Filtros para la tabla `postulacion_plaza`
--
ALTER TABLE `postulacion_plaza`
...
--
-- Filtros para la tabla `promociones_requisitos`
--
ALTER TABLE `promociones_requisitos`
...
--
-- Filtros para la tabla `promo_condiciones`
--
ALTER TABLE `promo_condiciones`
...
--
-- Filtros para la tabla `proveedor_tipo_pago`
--
ALTER TABLE `proveedor_tipo_pago`
...
--
-- Filtros para la tabla `receta_producto_global`
--
ALTER TABLE `receta_producto_global`
...
--
-- Filtros para la tabla `reclamos_cargos_responsables`
--
ALTER TABLE `reclamos_cargos_responsables`
...
--
-- Filtros para la tabla `servicios_delivery`
--
ALTER TABLE `servicios_delivery`
  ADD CONSTRAINT `servicios_delivery_ibfk_1` FOREIGN KEY (`sucursal_id`) REFERENCES `sucursales` (`id`);

--
-- Filtros para la tabla `solicitudes_cotizacion_fotos`
--
ALTER TABLE `solicitudes_cotizacion_fotos`
...
--
-- Filtros para la tabla `solicitudes_cotizacion_historial`
--
ALTER TABLE `solicitudes_cotizacion_historial`
...
--
-- Filtros para la tabla `solicitudes_cotizacion_productos`
--
ALTER TABLE `solicitudes_cotizacion_productos`
...
--
-- Filtros para la tabla `subgrupos_productos`
--
ALTER TABLE `subgrupos_productos`
  ADD CONSTRAINT `subgrupos_productos_ibfk_1` FOREIGN KEY (`grupo_id`) REFERENCES `grupos_productos` (`id`);

--
-- Filtros para la tabla `subgrupo_presentacion_producto`
--
ALTER TABLE `subgrupo_presentacion_producto`
...
--
-- Filtros para la tabla `tipo_receta_producto`
--
ALTER TABLE `tipo_receta_producto`
...
--
-- Filtros para la tabla `validacion_cv_ia`
--
ALTER TABLE `validacion_cv_ia`
...
--
-- Filtros para la tabla `variedad_producto_presentacion`
--
ALTER TABLE `variedad_producto_presentacion`
...
--
-- Filtros para la tabla `ventas_detalle_promociones`
--
ALTER TABLE `ventas_detalle_promociones`
...
--
-- Filtros para la tabla `ventas_extras`
--
ALTER TABLE `ventas_extras`
